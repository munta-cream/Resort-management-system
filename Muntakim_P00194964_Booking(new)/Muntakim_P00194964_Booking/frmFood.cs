...
namespace Muntakim_P00194964_Booking
{
    public partial class frmFood : Form
    {
        ...
        private void load_data()
        {
            ...
            gv1.Columns[3].DataPropertyName = "price";
        ...
        private void btnSearch_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                string Query = "Select * from tblFood where Name like '%" + SearchData + "%' OR Description like '%" + SearchData + "%' OR Price like '%" + SearchData + "%'";
